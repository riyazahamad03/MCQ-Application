...
function SignupUser() {
  ...
  const handleSubmitButton = async (event) => {
    ...
    if (passValidation && termsBox) {
      const signUpSuccess = await userSignUp(email, password, userName);
      if (signUpSuccess) {
        setEmail("");
        setPassword("");
        confirmSetPassword("");
            ...
            >
              ...
              {alertBox && (
                <div
                  ...
                  role="alert"
                >
                  <span className="font-medium">Error alert!</span> Change a few
